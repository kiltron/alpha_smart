...
class Test2SecondPage extends StatefulWidget {
  const Test2SecondPage({Key? key}) : super(key: key);

  @override
  State<Test2SecondPage> createState() => _Test2SecondPageState();
}

class _Test2SecondPageState extends State<Test2SecondPage> {
          ...
          body: Column(
            children: <Widget>[
              Container(
                ...
                child: const Text(
                  'Чтобы разделить десятичную дробь на 10, 100, 1000 и т.д., в какую сторону нужно перенести запятую в этой дроби?',
                  style: TextStyle(
                    fontSize: 18,
                    color: Colors.black,
                  ),
              ...
              GestureDetector(
                onTap: () {
                  ...
                  Navigator.push(
                    context,
                    MaterialPageRoute(
                        builder: (context) => const Test2ThirdPage()),
                  );
                },
                child: Container(
              ...
              Container(
                child: Tooltip(
                  ...
                  message:
                      'Подсказка\nВспомни правило деления десятичной дроби на степень 10.',
                  decoration: BoxDecoration(

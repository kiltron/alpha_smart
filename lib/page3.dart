...
import 'package:alpha_smart/page4.dart';
    ...
    return MaterialApp(
      ...
      home: Scaffold(
        ...
        body: Column(children: <Widget>[
          ...
          GestureDetector(
            onTap: () {
              if (textEditingController.text == '7,19' ||
                  textEditingController.text == '7.19') {
                globals.test1++;
              }
          ...
          Container(
            child: Tooltip(
              ...
              message:
                  'Подсказка\nПри сложении десятичных дробей не забудь: Дроби записывают в столбик – разряд под разрядом, запятую под запятой.',
              decoration: BoxDecoration(

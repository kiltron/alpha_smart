...
class Test2SixthPage extends StatefulWidget {
  const Test2SixthPage({Key? key}) : super(key: key);

  @override
  State<Test2SixthPage> createState() => _Test2SixthPageState();
}

class _Test2SixthPageState extends State<Test2SixthPage> {
              ...
              GestureDetector(
                onTap: () {
                  ...
                  Navigator.push(
                    context,
                    MaterialPageRoute(
                        builder: (context) => const Test2SeventhPage()),
                  );
                },
                child: Container(
